...
/* CORE_FW */
	...
	#define fw_mrotation_addr                       0x10007F3C
#endif
#ifdef HX_EDGE_LIMIT
	#define fw_edge_limit_level_addr            0x10007FE0
#endif
#ifdef HX_SENSIBILITY
	#define fw_sensibility_level_addr            0x10007FE4
#endif
...
#ifdef HX_DISPLAY_ROTATION
	#define fw_func_mrotation90_pwd		0xA11AA11A
	#define fw_func_mrotation270_pwd	0xA33AA33A
#endif
#ifdef HX_EDGE_LIMIT
	#define fw_func_edge_limit_level0_pwd			 0x5A5A5A5A
	#define fw_func_edge_limit_level1_pwd			 0x1A1A1A1A
	#define fw_func_edge_limit_level2_pwd			 0x2A2A2A2A
	#define fw_func_edge_limit_level3_pwd			 0x3A3A3A3A
	#define fw_func_edge_limit_level4_pwd			 0x5A5A5A5A
	#define fw_func_edge_limit_level5_pwd			 0x6A6A6A6A
	#define fw_func_edge_limit_level6_pwd			 0x7A7A7A7A
	#define fw_func_edge_limit_level7_pwd			 0x8A8A8A8A
	#define fw_func_edge_limit_level8_pwd			 0x9A9A9A9A
#endif
#ifdef HX_SENSIBILITY
	#define fw_func_sensibility_level1_pwd			 0xA55AA55A
	#define fw_func_sensibility_level2_pwd			 0xA33AA33A
	#define fw_func_sensibility_level3_pwd			 0xA11AA11A
#endif
...
#endif
#ifdef HX_EDGE_LIMIT
	uint8_t  addr_edge_limit_level[4];
#endif
#ifdef HX_SENSIBILITY
	uint8_t  addr_sensibility_level[4];
#endif
#ifdef HX_DISPLAY_ROTATION
	uint8_t  addr_mrotation[4];
#endif
...
#ifdef HEADLINE_MODE
	bool (*fp_headset_mode_set)(uint8_t state, bool suspended);
#endif
#ifdef HX_DISPLAY_ROTATION
	bool (*fp_mrotation_set)(uint8_t mrotation);
#endif
#ifdef HX_EDGE_LIMIT
	bool (*fp_edge_limit_level_set)(uint8_t level);
#endif
#ifdef HX_SENSIBILITY
	bool (*fp_set_sensibility_level)(uint8_t level);
#endif
