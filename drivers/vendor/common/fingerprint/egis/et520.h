...
/*#define FP_DEBUG for debug log print*/
#define FP_DEBUG
#ifdef FP_DEBUG
#define egislog_a(fmt,args...) printk(KERN_ALERT "[EGISTEC][ALERT]: %s: Line %d: " fmt, __FUNCTION__, __LINE__, ##args)
#define egislog_d(fmt,args...) printk(KERN_DEBUG "[EGISTEC][DEBUG]: %s: Line %d: " fmt, __FUNCTION__, __LINE__, ##args)
#define egislog_e(fmt,args...) printk(KERN_ERR "[EGISTEC][ERROR]: %s: Line %d: " fmt, __FUNCTION__, __LINE__, ##args)
#define egislog_i(fmt,args...) printk(KERN_INFO "[EGISTEC][INFO]: %s: Line %d: " fmt, __FUNCTION__, __LINE__, ##args)
#define DEBUG_PRINT printk
#else
#define egislog_a(fmt,args...) printk(KERN_ALERT "[EGISTEC][ALERT]: %s: Line %d: " fmt, __FUNCTION__,__LINE__,##args)
#define egislog_d(fmt,args...)
#define egislog_e(fmt,args...) printk(KERN_ERR "[EGISTEC][ERROR]: %s: Line %d: " fmt, __FUNCTION__,__LINE__,##args)
#define egislog_i(fmt,args...) printk(KERN_INFO "[EGISTEC]: %s: " fmt, __FUNCTION__, ##args)
#endif
...
struct egistec_data {
	...
	/*zte_fp_nav*/
	struct platform_device *pnavdev;
